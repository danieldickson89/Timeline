...
class UserController {
    ...
    static func followUser(user: User, completion: (success: Bool) -> Void) {
        ...
        FirebaseController.base.childByAppendingPath("/users/\(sharedUserController.currentUser.identifier!)/follows/\(user.identifier!)").setValue(true)
    ...
    static func unfollowUser(user: User, completion: (success: Bool) -> Void) {
        ...
        FirebaseController.base.childByAppendingPath("/users/\(sharedUserController.currentUser.identifier!)/follows/\(user.identifier!)").removeValue()
        ...
        FirebaseController.base.authUser(email, password: password) { (error, response) -> Void in
            ...
            if error != nil {
                ...
                UserController.userForIdentifier(response.uid, completion: { (user) -> Void in
                    ...
                    if let user = user {
                        sharedUserController.currentUser = user
                    }
    ...
    static func logoutCurrentUser() {
        ...
        UserController.sharedUserController.currentUser = nil
    }
