...
class ProfileViewController: UIViewController, UICollectionViewDataSource, ProfileHeaderCollectionReusableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        if user == nil {
            user = UserController.sharedUserController.currentUser
...
//        }
    ...
    func userTappedFollowActionButton() {
        ...
        if user == UserController.sharedUserController.currentUser{
            ...
            UserController.userFollowsUser(UserController.sharedUserController.currentUser, followsUser: user) { (follows) -> Void in
